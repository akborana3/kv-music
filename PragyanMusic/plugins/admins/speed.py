...
from PragyanMusic.utils import AdminRightsCheck
from PragyanMusic.utils.database import is_active_chat, is_nonadmin_chat
from PragyanMusic.utils.decorators.language import languageCB
from PragyanMusic.utils.inline import close_markup, speed_markup
...
async def del_back_playlist(client, CallbackQuery, _):
    ...
    try:
        await PragyanMusic.speedup_stream(
            chat_id,
            file_path,
            speed,
            playing,
